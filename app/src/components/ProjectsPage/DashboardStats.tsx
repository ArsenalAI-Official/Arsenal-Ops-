...
const DashboardStats = ({ userName, myTasks, myTasksLoading, onTabChange }: DashboardStatsProps) => {
    const now = new Date();
    ...
    return (
        <div className="flex items-stretch gap-5 mb-8">
            <div className="flex-1 bg-[rgba(255,255,255,0.025)] border border-[rgba(255,255,255,0.05)] rounded-2xl px-6 py-5 flex flex-col justify-center relative overflow-hidden">
                ...
                >
                    <path d="M 180 100 C 260 72, 340 88, 390 58 C 430 33, 490 52, 600 18 L 600 100 Z" fill="rgba(212,160,23,0.07)" />
                    <path d="M 300 100 C 355 76, 415 84, 455 62 C 495 40, 545 54, 600 36 L 600 100 Z" fill="rgba(212,160,23,0.10)" />
                    <path d="M 420 100 C 458 80, 505 79, 542 64 C 566 54, 585 57, 600 50 L 600 100 Z" fill="rgba(212,160,23,0.13)" />
                </svg>
