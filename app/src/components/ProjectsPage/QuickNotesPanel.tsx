    ...
    return (
        <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-2">
            <div className={`transition-all duration-300 origin-bottom-right ${
                ...
                <div className="w-80 bg-[#111] border border-[rgba(255,255,255,0.10)] rounded-2xl shadow-2xl shadow-black/60 flex flex-col overflow-hidden" style={{ height: '340px' }}>
                    <div className="flex items-center justify-between px-4 py-3 border-b border-[rgba(255,255,255,0.07)] flex-shrink-0">
                        ...
                        <div className="flex items-center gap-2">
                            <span className={`text-xs transition-colors duration-300 ${notepadSaved ? 'text-[#E0B954]' : 'text-[#737373]'}`}>
