...
interface GitHubSettingsModalProps {
  ...
  gitHubForm: { github_repo_url: string; github_repo_name: string; github_token: string };
  setGitHubForm: React.Dispatch<React.SetStateAction<{ github_repo_url: string; github_repo_name: string; github_token: string }>>;
  setShowGitHubModal: (show: boolean) => void;
  handleSaveGitHubSettings: () => void;
}

const GitHubSettingsModal: React.FC<GitHubSettingsModalProps> = ({
  showGitHubModal,
  editingProject,
  gitHubForm,
  setGitHubForm,
  ...
  if (!showGitHubModal || !editingProject) return null;
