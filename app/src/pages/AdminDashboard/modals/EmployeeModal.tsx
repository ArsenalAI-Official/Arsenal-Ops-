...
interface EmployeeModalProps {
  ...
  employeeForm: { name: string; email: string; github_username: string; specialization: string };
  setEmployeeForm: React.Dispatch<React.SetStateAction<{ name: string; email: string; github_username: string; specialization: string }>>;
