...
interface UserModalProps {
  ...
  userForm: { email: string; name: string; roles: string[] };
  setUserForm: React.Dispatch<React.SetStateAction<{ email: string; name: string; roles: string[] }>>;
  generatedPassword: string | null;
  setGeneratedPassword: (pw: string | null) => void;
