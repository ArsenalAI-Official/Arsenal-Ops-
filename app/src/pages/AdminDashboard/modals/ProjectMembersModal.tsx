...
interface ProjectMembersModalProps {
  ...
  selectedProjectForMembers: Project | null;
  projectMembers: ProjectMember[];
  projectMembersLoading: boolean;
  employees: Employee[];
  addMemberForm: { developer_id: string; role: string };
  setAddMemberForm: React.Dispatch<React.SetStateAction<{ developer_id: string; role: string }>>;
...
const ProjectMembersModal: React.FC<ProjectMembersModalProps> = ({
  ...
  if (!showProjectMembersModal || !selectedProjectForMembers) return null;
