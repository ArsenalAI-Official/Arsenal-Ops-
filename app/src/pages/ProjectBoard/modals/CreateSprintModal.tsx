...
interface CreateSprintModalProps {
  ...
  setShowCreateSprintModal: React.Dispatch<React.SetStateAction<boolean>>;
  newSprint: NewSprint;
  setNewSprint: React.Dispatch<React.SetStateAction<NewSprint>>;
  showCalendarSprintStart: boolean;
  setShowCalendarSprintStart: React.Dispatch<React.SetStateAction<boolean>>;
  showCalendarSprintEnd: boolean;
  setShowCalendarSprintEnd: React.Dispatch<React.SetStateAction<boolean>>;
...
const CreateSprintModal: React.FC<CreateSprintModalProps> = ({
  ...
  newSprint,
  setNewSprint,
  showCalendarSprintStart,
  setShowCalendarSprintStart,
  showCalendarSprintEnd,
  setShowCalendarSprintEnd,
  handleCreateSprint,
}) => {
  if (!showCreateSprintModal) return null;
