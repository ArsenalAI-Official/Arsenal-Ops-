...
const mockPulseData: PulseData = {
  ...
  forecastVsActuals: {
    ...
    last: [
      { feature: 'Auth', employee: 'Alice', fc: 20, act: 20 },
    ],
    project: [
...
describe('PulseTab', () => {
  ...
  it('mounts and renders tab content when data is available', () => {
    renderWithProviders(
      <PulseTab hubLoading={false} pulseData={mockPulseData} />,
    )
  ...
  it('displays loading skeleton when hubLoading is true', () => {
    renderWithProviders(
      <PulseTab hubLoading={true} pulseData={null} />,
    )
  ...
  it('displays loading skeleton when pulseData is null', () => {
    renderWithProviders(
      <PulseTab hubLoading={false} pulseData={null} />,
    )
  ...
  it('renders contract value in hero card', () => {
    ...
    const heroText = document.querySelector('header')?.textContent || document.body.textContent || ''
  ...
  it('gracefully handles empty forecast vs actuals data', () => {
    ...
    renderWithProviders(
      <PulseTab hubLoading={false} pulseData={emptyForecastData} />,
    )
